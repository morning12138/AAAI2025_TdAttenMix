...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/home/wzming/DLprojects/datasets/imagenet', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19', 'TINYIMG', 'CUB_species'],
...
def main(args):
    ...
    if mixup_active:
        from tdattenmix import TdAttenMix
        mixup_fn = TdAttenMix(
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            if epoch % 300:
                checkpoint_paths = [output_dir / 'checkpoint300.pth']
                for checkpoint_path in checkpoint_paths:
                    utils.save_on_master({
                        'model': model_without_ddp.state_dict(),
                        'optimizer': optimizer.state_dict(),
